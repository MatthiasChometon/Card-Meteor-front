...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    ProductOrderBy: typeof import('./components/products/orderBy/ProductOrderBy.vue')['default']
    ProductOrderDirection: typeof import('./components/products/orderBy/ProductOrderDirection.vue')['default']
    ProductSearch: typeof import('./components/products/filterBy/ProductSearch.vue')['default']
