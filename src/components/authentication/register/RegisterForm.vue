...
onDone((result) => {
  ...
  sendNotification(
    result,
    { path: "register.onSuccess", variables },
    { path: "register.onError" }
  );
    ...
    <q-form class="q-gutter-md q-pt-md" @submit="register({ input: newUser })">
      <q-input
        ...
        :rules="[
          (val) =>
            (val && val.length > 0) ||
            t('form.rulesError.empty', { key: t('register.firstName') }),
        ]"
      />
      ...
      <q-input
        ...
        :rules="[
          (val) =>
            (val && val.length > 0) ||
            t('form.rulesError.empty', { key: t('register.lastName') }),
        ]"
      />
      ...
      <q-input
        ...
        :rules="[
          (val) =>
            (val && val.length > 0) ||
            t('form.rulesError.empty', { key: t('register.username') }),
        ]"
      />
      ...
      <q-input
        ...
        :rules="[
          (val) =>
            (val && isPhoneValid) ||
            t('form.rulesError.phoneNotValid', { key: t('register.phone') }),
        ]"
      />
      ...
      <q-input
        ...
        :rules="[
          (val) =>
            (val && val.length > 6) ||
            t('form.rulesError.empty', { key: t('register.password') }),
        ]"
        lazy-rules
        outlined
      ...
      <q-input
        ...
        outlined
        :label="t('register.repeatedPassword')"
        lazy-rules
        :rules="[
          (val) =>
            (val && val === newUser.password) ||
            t('form.rulesError.repeatedPasswordNotValid'),
        ]"
