...
const isAccount: boolean = $ref(false);
</script>
<template>
  <div>
  ...
  <div class="q-pa-md">
    <q-dialog v-model="isDisplay">
      ...
      >
        ...
        <q-card-section>
          <div v-if="isAccount === false">
            <FormConnexion style="margin-left: auto; margin-right: auto" />
            <div style="text-align: center">
              <a @click="isAccount = true"> {{ t(`Form.Login.no-account`) }}</a>
            </div>
          </div>
          <div v-else>
            <FormInscription style="margin-left: auto; margin-right: auto" />
            <div style="text-align: center">
              <a text-align: center @click="isAccount = false">
                {{ t(`Form.Register.haveAccount`) }}</a
              >
            </div>
          </div>
        </q-card-section>
